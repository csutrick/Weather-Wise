...
const Footer = () => {
  ...
  return (
    <footer className='w-full flex flex-row justify-center items-center pb-16'>
      <div className='bg-gray-600 w-[1250px] p-8 mx-12 flex flex-col md:flex-row justify-between items-start md:items-end rounded-2xl drop-shadow-md'>
        <ul className=''>
          <Link to="/">
        ...
        <div className='flex flex-row'>
          <div className='mr-4 flex flex-col items-center'>
            <label className='mb-1 text-white font-bold drop-shadow-md whitespace-nowrap'>View Project Code</label>
          ...
          <div className='flex flex-col items-center'>
            <label className='mb-1 text-white font-bold drop-shadow-md whitespace-nowrap'>View Github</label>
